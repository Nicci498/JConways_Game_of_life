...
function Pic({setShowGrid}){
    return(
        <div className='pic'>
            <div className = 'spacer'></div>
            <img onClick={() => setShowGrid(true)} src='https://media.wired.com/photos/595481de8e8cc150fa8ec1f3/191:100/pass/Conway_1k.jpg' alt='portrait of James Conway' copyright='PRINCETON UNIVERSITY, OFFICE OF COMMUNICATIONS/DENISE APPLEWHITE'></img>
            <p className='click'>(Click portrait to play)</p>
            <h3>1937 - 2020</h3>
